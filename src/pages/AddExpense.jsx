  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center font-lilita p-4 border
      ...
      <div className="bg-white rounded-[22px] w-full max-w-sm p-8 shadow-figma text-center relative">
        ...
        <h1 className="text-[45px] mb-8 text-[#E04847]">
          EXPENSE
        </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 text-left">
          <div>
            ...
            <input
              ...
              className="w-full bg-gray-50 rounded-xl px-4 py-3 text-[#000000] outline-none border-2 border-transparent focus:border-red-300 transition"
              autoFocus
            />
          </div>
          ...
          <div className="pt-4 flex flex-col gap-3">
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#E04847] text-white py-3 rounded-2xl text-[20px] shadow-figma hover:brightness-110 transition transform active:scale-95"
            >
              {loading ? 'Saving...' : 'Save'}
            </button>
