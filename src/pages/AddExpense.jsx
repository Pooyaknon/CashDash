...
function AddExpense() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await transactionService.addTransaction({ description, amount: parseFloat(amount), type: 'expense', category, date: selectedDate })
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center font-lilita p-4
      ...
      <div className="bg-white dark:bg-gray-800 dark:border dark:border-gray-700 rounded-[22px] w-full max-w-sm p-8 shadow-figma text-center">
        ...
        <h1 className="text-[45px] mb-8 text-[#E04847]">EXPENSE</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6 text-left">
          <div>
            ...
            <input
              ...
              className="w-full bg-gray-50 dark:bg-[#233D58] dark:text-gray-100 dark:placeholder-gray-500 rounded-xl px-4 py-3 outline-none border-2 border-transparent focus:border-[#E04847] transition"
              autoFocus
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="0.00"
                className="w-full bg-gray-50 dark:bg-[#233D58] dark:text-gray-100 dark:placeholder-gray-500 rounded-xl px-4 py-3 pr-16 outline-none border-2 border-transparent focus:border-[#E04847] transition"
              />
          ...
          <div className="relative">
            ...
            <button
              ...
              className="w-full bg-gray-50 dark:bg-[#233D58] dark:text-gray-100 dark:placeholder-gray-500 rounded-xl px-4 py-3 outline-none border-2 border-transparent focus:border-[#E04847] transition flex items-center justify-between"
            >
              <span>{category}</span>
          ...
          <div className="pt-4 flex flex-col gap-3">
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#E04847] text-white py-3 rounded-2xl text-[20px] shadow-figma hover:brightness-110 transition active:scale-95"
            >
              {loading ? 'Saving...' : 'Save'}
            </button>
            <button
